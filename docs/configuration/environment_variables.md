...
The audit found 59 variables read by a single model or pipeline family. They are
...
| --- | ---: | --- |
| Promote | 36 | Move a stable setting into typed stage or model configuration. |
